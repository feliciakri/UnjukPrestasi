<?php
    ...
    if(isset($_POST["submit"])) {
        ...
        //input data
        $conn = connectDB();
        $sql = "INSERT INTO `prestasi_guru`(`id_prestasi`, `nama_guru`, `prestasi_guru`, `kategori`, `bulan`, `tahun`, `region`, `deskripsi`) VALUES (NULL, '$namaguru', '$prestasi', '$kategori', '$bulan', '$tahun', '$region', '$deskripsi')";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <?php echo "<span style='color:red'>".$resp."</span>"; ?>
                        <form method="POST" action="form_prestasi_guru.php" role="form">
